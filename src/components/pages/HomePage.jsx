...
return (
    ...
    <section className='h-auto md:h-96 relative group'>
      <div className='backdrop-blur-sm bg-white/30 w-full h-full inset-y-2.5 absolute hidden group-hover:flex items-center justify-center duration-200' onClick={()=> navigate("/my-ecom-project/categories/electronics")}>
    ...
    <section className='h-auto md:h-96 flex flex-col md:flex-row items-center justify-center gap-4'>
      <div className='relative group'>
        <div className='backdrop-blur-sm bg-white/30 w-full h-full inset-y-2.5 absolute hidden group-hover:flex items-center justify-center duration-200' onClick={() => navigate("/my-ecom-project/categories/jewelery")}>
