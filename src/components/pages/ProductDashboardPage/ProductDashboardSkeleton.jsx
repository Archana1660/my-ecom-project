    ...
    <div className="flex justify-center min-h-screen ">
        <section className="bg-neutral-100 p-2 m-2 shadow-2xl rounded-3xl md:p-10">
            <div className="grid gap-5 grid-col-1 sm:grid-cols-2 lg:grid-cols-3">
               <div className="shadow-lg rounded-xl p-10 md:p-5 lg:p-10 bg-white group flex flex-col justify-center sm:w-72 lg:w-[22rem]">
                    <div className="bg-gray-300 animate-pulse rounded-2xl h-56 w-52 self-center"></div>
